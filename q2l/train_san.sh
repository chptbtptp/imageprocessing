python q2l_train.py --dataname 'heart' -a 'Q2L-SwinL-384' --img_size 224 -b 16 --epochs 100 --lr 0.00000005 --num_labels 3 #--resume checkpoint/Q2L-SwinL-384/heart/12/model_best.pth.tar
